...
公司与市场背景事实核查日2026-09-19；E21–E23芯片内部说明及供应商试点于2026-09-20补充。本表保留会影响研究结论的关键口径，不是原文转载。

**市场规模新增证据：** 三家厂商试点的原始值、逐项排除理由、页码和P01—P08来源见[试点证据报告](market_sizing_pilot.md)，纳入状态见[供应商底表](vendor_shipment_ledger.md)。智邦2023年原表可复算销量3,208,667台，但不是2025年DC直供数量；本轮三家2025年可纳入且去重完成的数量记录为0条，表示缺资料而非零市场。未形成独立总量，未执行机构总量数值比对。
...
| 年度产品族供货量及用途 | 供应商主模型的数量起点，公开总收入/累计端口不能替代 | OEM/ODM销售运营、交付与采购核对 |
| ODM直供/品牌代工和集团转售 | 同一台交换机可能在多家公司出现 | 项目对应表、销售路径及跨期库存验证 |
...
本手册未编造这些缺失数据。新版供应商底表保留空项；旧Excel仅使用显式演示假设，已改作架构教学和辅助校验。
